...
public class MyHomeAdapter extends RecyclerView.Adapter {
    ...
    public MyHomeAdapter(Context context, ArrayList<HomeItemBean.ResultBean.DataBean> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View inflate = LayoutInflater.from(context).inflate(R.layout.layout_home_item, viewGroup, false);
